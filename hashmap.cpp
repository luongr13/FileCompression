...
//
// Description: 
// Implementation for a hashmap that uses chaining to handle collisions via linked list.
//
...
void hashmap::put(int key, int value) {
	// get index
	int i = hashFunction(key) % nBuckets;
	...
	// key does not exist, create a new key_val_pair
	cur = buckets[i];
